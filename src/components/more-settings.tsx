  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="transition-base rounded-full p-2.5 flex items-center gap-4 text-xl group-hover:bg-tw-primary/10 xl:pr-8">
      ...
      <DropdownMenuContent
        className="sm:min-w-80 shadow-[rgba(255,_255,_255,_0.2)_0px_0px_15px,rgba(255,_255,_255,_0.15)_0px_0px_3px_1px] p-0"
        align="start"
        alignOffset={12}
      >
          ...
          return (
            <DropdownMenuItem key={link.label} asChild>
              <Link
                href={link.href}
                className={cn(
                  "w-full h-full gap-6 [&_svg]:size-6 cursor-pointer text-xl font-bold !p-4 !rounded-none",
